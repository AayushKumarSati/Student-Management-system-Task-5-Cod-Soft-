...
public class student_Managment {
    ...
    public void add_student(String name, int roll_Number) {
        Student student = new Student(name, roll_Number);
    ...
    public void display_Now() {
        ...
        for (Student student : students) {
            ...
            System.out.println("Your Name Is :" + student.get_User_Name() + "Roll Number Is : "
        ...
        while (true) {
            ...
            switch (choices) {
                case 1:
                    ...
                    System.out.println("Enter A Student Roll Number Is :");
                    int get_Roll_Number = scn.nextInt();
                    system.add_student(get_User_Name,get_Roll_Number);
                    break;
                case 2:
                    system.display_Now();
                    break;
                case 3:
                    ...
                    System.exit(0);
                default:
                    System.out.println("Sorry Invlid Choice Please Try Again Later");
            }
